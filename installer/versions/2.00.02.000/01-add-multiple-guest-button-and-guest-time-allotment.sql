...
# BatchGuestPassUsernameLabel - The text for the first line of the guest pass (followed by the username)
# BatchGuestPassPasswordLabel  - The text for the second line of the guest pass (followed by the password)
